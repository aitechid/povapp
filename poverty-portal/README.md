...
Portal Penanggulangan Kemiskinan adalah platform analisis data spasial dan kuantitatif terintegrasi yang dirancang untuk mendukung pengambilan keputusan kebijakan sosial secara presisi. Platform ini memetakan, menganalisis, dan mengeksplorasi data **PBDT (Basis Data Terpadu)** nasional yang dinamis serta data kemiskinan makro dari Badan Pusat Statistik (BPS).
